...
public class ChineseToSpell {
	public static ChineseToSpell _ChineseToSpell = new ChineseToSpell();
	public static ChineseToSpell getInstance(){
		return _ChineseToSpell;
	}
	
	
	public static void main(String[] args){
		System.out.println(ChineseToSpell.getInstance().getFullSpell("你是哪位"));
		System.out.println(ChineseToSpell.getInstance().getFirstSpell("jas你是哪位"));
	}

	private  LinkedHashMap spellMap = null; 
