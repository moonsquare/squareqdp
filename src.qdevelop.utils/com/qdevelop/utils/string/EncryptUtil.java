package com.qdevelop.utils.string;
...
public class EncryptUtil {
	private static EncryptUtil _EncryptUtil = new EncryptUtil();
	
	public static EncryptUtil getInstance() throws Exception{
		return _EncryptUtil;
	}
	
//	private static  String strDefaultKey = QDevelop.serverIp==null?"QDevelop_Framework":QDevelop.serverIp;
...
//		try {
////			String ee = EncryptUtil.getInstance().encrypt("admin#admin");
//			Map t = new HashMap();
//			t.put("asss", "asdfasdfasddfa");
//			System.out.println(t.hashCode());
////			System.out.println(EncryptUtil.getInstance().decrypt(ee));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//	}
